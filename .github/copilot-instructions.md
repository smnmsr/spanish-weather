...
- **Development Language**: All code, tests, comments, commit messages, and documentation should be written in **English**. The app UI is in German for end-users, but the development language is English.
...
- whenever possible, use only the components from https://www.shadcn-vue.com/docs/components, these are:
    ...
    - Tooltip
    - Typography
    - Components can be added using `npx shadcn-vue@latest add [component-name]`
